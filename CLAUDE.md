...
| 3 | Instagram | 未着手。⚠️**個人インスタと紐付けないため、ログアウト状態のプライベートウィンドウで作る**。アプリの「アカウントを追加」から作るとアカウントセンターにまとめられやすい |
| 4 | Threads | 未着手（IGができたらログインするだけ） |
| 5-7 | X / note / dev.to / Pinterest | 未着手 |
