...
- **バナー**：5媒体（YouTube 2048×1152 / dev.to 1600×640 / X 1500×500 / note 1280×670 / Facebook 820×312）。⚠️**IG・Threads・TikTokにバナーは無い**
...
| 6-7 | note / dev.to / Pinterest | 未着手。⚠️どれもブラウザで完結し、Xのようなアプリ限定もMetaのような連携もない |
...
- **⚠️アカウント作成は必ずmtさん自身**（Claudeは作成不可）。プロフィールのリンクは**ルートポータル（wisdomassemble.com）**に集約する（各テナントを個別に貼らない）。
