...
| 4 | **件数上限の可視化**（「200件中200件を表示」＋ページ送り or 「もっと読む」） | ⛔黙って切らない。⭐これが無いと1〜3を入れても「無いのか、切れたのか」が分からない |
...
**⚠️スループットの見立て（2026-08-29 時点で未確定）**
- mtさん試算＝**1日225件程度**。⚠️根拠となる **Gemini無料枠のRPD（日次上限）はコードにもCLAUDE.mdにも数字が無い**ので、この225は未検証
