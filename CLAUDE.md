...
- **正直な立ち上げ**: 質問=ユーザー/友人の本物の疑問、AI回答（明示ラベル）主体＋少数の本物の人間回答。各テナント10問前後（量より質）。
...
**宣伝・SEO**
- 順序: 質問投入→AdSense申請→承認→広告ON→ローンチ弾（Show HN/r/SideProject、一発カードは温存）。承認前は「答える側」のコミュニティ参加のみ（信頼貯め）。
