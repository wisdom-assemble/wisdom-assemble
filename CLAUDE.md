...
- [x] ~~**C1'. サブドメインのsitemapをGSCに送信**~~ ✅**2026-08-27 完了。** ⚠️⚠️**それまでルートの1本しか登録されておらず、新67問がsitemap経由でGoogleに一度も伝わっていなかった。** 「インデックスされていない」のは時間の問題ではなく、**そもそも知らせていなかった**のが原因。送信当日に読み込まれ guitar 46 / music-prod 44 ページを検出。⛔**GSCはドメインプロパティでもsitemapはホストごとに送る必要がある**
