...
update tenants set description = 'AIが答えられない・不確かなチェンマイ移住に関する質問・問題を、人間のエキスパートに繋げるQ&Aサービス' where id = 'chiangmai';
...
update tenants set description = 'AIが答えられない・不確かなカナダ留学に関する質問・問題を、人間のエキスパートに繋げるQ&Aサービス' where id = 'canada';
