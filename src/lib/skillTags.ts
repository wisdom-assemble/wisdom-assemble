...
export const TENANT_SUGGESTED_KEYWORDS: Record<string, string[]> = {
  ...
  // 31問での実出現数を数えて確定（2026-08-15）。押して0件になる語は置かない。
  // ビンテージ9 / マルチエフェクター8 / エフェクター5 / アンプ4 / オーバードライブ3 /
  // アコギ3 / ファズ2 / ピックアップ2 / ノイズ1。
  // 「弦高」は0問だったため除外し、4問ある「アンプ」に差し替えた。
  guitar: [
    'エフェクター', 'オーバードライブ', 'ファズ', 'マルチエフェクター',
    'ピックアップ', 'アコギ', 'ノイズ', 'アンプ', 'ビンテージ',
  ],
}
