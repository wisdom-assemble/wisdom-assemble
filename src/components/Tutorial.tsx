...
const SLIDES = [
  {
    icon: '●',
    title: 'AIが先に回答します',
    body: '質問を投稿すると、まずAIが回答を試みます。信頼度が高い場合はAIの回答がそのまま表示されます。',
  },
  {
    icon: '●',
    title: 'AIが無理なら人間へ',
    body: 'AIが自信を持って答えられない質問は、スキルタグが一致する専門家に自動でマッチングされます。AIの隙間を人間が埋めます。',
  },
  {
    icon: '▲',
    title: '高難度質問で全員参加',
    body: '2人の専門家でも解決しない場合、「高難度質問」として全員に公開されます。あなたの知識が誰かを救うかもしれません。',
  },
]
